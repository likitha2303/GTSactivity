...
//import CandidateOnJob from './pages/CandidateAgreement';
import CandidateAgreement from './pages/CandidateAgreement';
    ...
    <BrowserRouter>
      ...
      <Provider store={store}>
        <Switch>
          ...
          <Route path="/CandidateAgreement" component={CandidateAgreement}exact></Route>
          <Route path="/CandidateJob" component={CandidateJob}exact></Route>
          <Route
            path="/homepage"
